...
func display_wasm_output(string_val, number_val, byte_result, json_text):
	...
	var wasm_string_result_reverse = get_wasm_string_reverse(string_val)
	var wasm_int_double_result = get_int_double(number_val)
